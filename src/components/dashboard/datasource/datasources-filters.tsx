...
export interface DatasourcesFiltersProps {
  filters?: Filters;
  sortDir?: SortDir;
}

export function DatasourcesFilters({ filters = {}, sortDir = 'desc' }: DatasourcesFiltersProps): React.JSX.Element {
  ...
  const updateSearchParams = React.useCallback(
    (newFilters: Filters, newSortDir: SortDir): void => {
      ...
      router.push(`${paths.dashboard.datasources.list}?${searchParams.toString()}`);
    },
    [router]
  );
