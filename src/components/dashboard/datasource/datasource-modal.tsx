...
const images = [
  { id: 'IMG-001', url: '/assets/datasource-1.png', fileName: 'datasource-1.png', primary: true },
] satisfies Image[];
...
export function DatasourceModal({ open }: DatasourceModalProps): React.JSX.Element | null {
  const router = useRouter();

  // This component should load the datasource from the API based on the datasourceId prop.
          ...
          <Stack spacing={3}>
            <Stack direction="row" spacing={3} sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <Button
                ...
                href={paths.dashboard.datasources.details('1')}
