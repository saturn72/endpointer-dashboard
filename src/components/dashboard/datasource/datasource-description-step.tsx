...
export interface DatasourceDescriptionStepProps {
  onBack?: () => void;
  onNext?: () => void;
}

export function DatasourceDescriptionStep({ onBack, onNext }: DatasourceDescriptionStepProps): React.JSX.Element {
  ...
  return (
    <Stack spacing={4}>
      <Stack spacing={3}>
        <div>
          <Typography variant="h6">How would you describe the datasource post?</Typography>
        </div>
